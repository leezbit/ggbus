...
- 정류장 기기에 `API 상태` 센서를 추가해 최근 시도/성공/오류 시각, 연속 오류 횟수, 권장 조치까지 확인 가능
...
| 구분 | 엔티티 | 값 예시 |
|---|---|---|
| 정류장 | API 상태 | 정상 / 데이터 지연 / 인증 실패 / 할당량 초과 / API 응답 오류 |
| 노선 | 1번째 도착예정 | 3 (분) / 대기 중 |
| 노선 | 1번째 전 정류장 | 2 (번째 전) / 정보없음 |
| 노선 | 1번째 저상버스 | 일반 / 저상 / 2층 / 전세 / 예약 / 트롤리 |
| 노선 | 2번째 도착예정 | 7 (분) / 대기 중 |
| 노선 | 2번째 전 정류장 | 5 (번째 전) / 정보없음 |
| 노선 | 2번째 저상버스 | 일반 / 저상 / 2층 / 전세 / 예약 / 트롤리 |
